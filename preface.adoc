...
Varje halva av strofen inleds med två rader som bildar en fjärding, precis som i fornyrdislag. Sedan kommer en rad med tre betonade stavelser varav minst två ska stavrimma med varandra.
